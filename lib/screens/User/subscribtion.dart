    ...
    if (selectedBoxIndex >= 0) {
      ...
      try {
        ...
        if(choice1Selected) {
          ...
          makePayment('${selectedSubscription.price}00');
        }
        if (response.statusCode == 200) {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/img/GOFit.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        Container(
          ...
          Text(' Your Subscription Valid', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
            ...
            Row(children: [
              ...
              Text('From: ${dateFormat.format(startDate)}',style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400)),
              SizedBox(width: 10),

              Text('to: ${dateFormat.format(endDate)}',style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400)),
            ],),
            SizedBox(height: 16),
            ElevatedButton(
              onPressed: () {
